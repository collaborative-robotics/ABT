...
msg='--*---GIX Fri----*----   multinomial (new B-perturb + commented checker)  6 state BW: task01 '
...
msg='--*---GIX Fri----*----   multinomial (new B-perturb + commented checker)  6 state Vit: task02 '
python tl_abt2hmm.py  0.00 "$msg" & python tl_abt2hmm.py  0.1 "$msg"& python tl_abt2hmm.py  0.2 "$msg"& python tl_abt2hmm.py  0.50 "$msg" & python tl_abt2hmm.py  6.0 "$msg" 
 

cp task03.py abt_constants.py

msg='--*---GIX Fri----*----   multinomial (new B-perturb + commented checker)  16 state BW: task03'
python tl_abt2hmm.py  0.00 "$msg" & python tl_abt2hmm.py  0.1 "$msg"& python tl_abt2hmm.py  0.2 "$msg"& python tl_abt2hmm.py  0.50 "$msg" & python tl_abt2hmm.py  6.0 "$msg" 
 

cp task04.py abt_constants.py

msg='--*---GIX Fri----*----   multinomial (new B-perturb + commented checker)  16 state Vit: task04'
python tl_abt2hmm.py  0.00 "$msg" & python tl_abt2hmm.py  0.1 "$msg"& python tl_abt2hmm.py  0.2 "$msg"& python tl_abt2hmm.py  0.50 "$msg" & python tl_abt2hmm.py  6.0 "$msg" 
